...
|----------|-----------------|----------------------|--------------|--------------|--------------|-------------------|
| Arabic   | v1.0            | [Gdrive (only 25k pages) ](https://drive.google.com/file/d/1Si0wTQ9sDm5744f_gFWEo2cFNzYcgi9i/view?usp=drive_link)            | TBD          | TBD          | TBD          | To obtain the full dataset, please contact us at: deepcolab01[at]gmail.com [not free]               |
